...
@Autonomous
public class Auto_BlueAlliance3 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        Pose2d grabSpecimentPos =  new Pose2d(-50, 64, Math.toRadians(90));
        ...
        TrajectoryActionBuilder goToOberservationZone_1 = initialCycle.endTrajectory().fresh()
                ...
                .splineToLinearHeading(new Pose2d(-45, 10, Math.toRadians(270)), Math.toRadians(90))
                ...
                .strafeToLinearHeading(new Vector2d(-45, 64), Math.toRadians(270));
        TrajectoryActionBuilder goToSubmersible_fromOZone1 = goToOberservationZone_1.endTrajectory().fresh()
                ...
                .strafeToLinearHeading(new Vector2d(-40,  58), Math.toRadians(270))
        ...
        TrajectoryActionBuilder goToOberservationZone_2 = goToSubmersible_fromOZone1.endTrajectory().fresh()
                ...
                .lineToYLinearHeading(64, Math.toRadians(270));

        TrajectoryActionBuilder goToSubmersible_fromOZone2 = drive.actionBuilder(grabSpecimentPos)
                .waitSeconds(0.5)
                .strafeToLinearHeading(new Vector2d(-50,  58), Math.toRadians(270))
