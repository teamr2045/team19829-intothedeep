...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = (-1968.9964082630443 + -1967.7184050095343 + -1904.2692965618928)/3; // y position of the parallel encoder (in tick units)
        // 232.42134886929844
        public double perpXTicks = (-6892.1655835804595 + -6784.089869954859 + -6885.381238240674) / 3; // x position of the perpendicular encoder (in tick units)
    }
    ...
    public TwoDeadWheelLocalizer(HardwareMap hardwareMap, IMU imu, double inPerTick) {
        ...
        DcMotorEx parEncoder = hardwareMap.get(DcMotorEx.class, "frontRight");
        DcMotorEx perpEncoder = hardwareMap.get(DcMotorEx.class, "rearLeft");
