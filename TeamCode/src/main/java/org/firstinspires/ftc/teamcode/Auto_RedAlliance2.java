...
@Autonomous
public class Auto_RedAlliance2 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        TrajectoryActionBuilder initialCycle = drive.actionBuilder(initialPose)
                ...
                .splineToLinearHeading(new Pose2d(3, -30, Math.toRadians(270.00)), Math.toRadians(90))
                .endTrajectory();
...
//                .afterTime(0, new ParallelAction(lifter.setLifterPosition_v2(1780)))
                .splineToLinearHeading(new Pose2d(2.5, -31, Math.toRadians(90)), Math.toRadians(270));
