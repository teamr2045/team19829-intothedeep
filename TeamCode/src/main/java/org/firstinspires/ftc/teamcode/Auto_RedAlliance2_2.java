...
@Autonomous(name = "Auto RedAlliance 2.2")
public class Auto_RedAlliance2_2 extends LinearOpMode {

    private int lifterHighRungSetpoints = 1400;
    ...
    public void runOpMode() {
        ...
        TrajectoryActionBuilder initialCycle = drive.actionBuilder(initialPose)
                ...
                .splineToLinearHeading(new Pose2d(3, -32, Math.toRadians(270.00)), Math.toRadians(90))
                .endTrajectory();
...
//                .splineTo(new Vector2d(64, 1.01), Math.toRadians(0.00))
                .splineToConstantHeading(new Vector2d(47, -15.25), Math.toRadians(90))
...
//                .splineToLinearHeading(new Pose2d(2.5, -31, Math.toRadians(270.00)), Math.toRadians(90));
                .strafeToLinearHeading(new Vector2d(47,  -58), Math.toRadians(90))

                .splineToLinearHeading(new Pose2d(2.5, -30, Math.toRadians(270.00)), Math.toRadians(90));
...
//                .splineToLinearHeading(new Pose2d(2.5, -30, Math.toRadians(270.00)), Math.toRadians(90)
        ...
        TrajectoryActionBuilder goToSubmersible_fromOZone2 = drive.actionBuilder(grabSpecimentPos)
                ...
                .splineToLinearHeading(new Pose2d(2.5, -30, Math.toRadians(90)), Math.toRadians(270));
        ...
        Action trajectoryAction = new SequentialAction(
                ...
                new ParallelAction(
                        ...
                        lifter.setLifterPosition_v2(lifterHighRungSetpoints),
